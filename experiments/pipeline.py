...
#construct output file:
    result_folder = os.path.join(currentdir,'Result',args.problem.upper(),args.algorithm.upper()+'_' +args.problem.upper()+'_'+args.var)
    try:
...
#construct image file:
    images_folder = os.path.join(currentdir,'Result', 'Images',args.problem.upper(),args.algorithm.upper()+'_' +args.problem.upper()+'_'+args.var)
...
#summary table:
    ...
    table_path = os.path.join(currentdir,'Result','result_with_popsize_large_memory')
